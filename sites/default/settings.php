 ...
 * Read the LOCAL_SETTINGS_README.txt for local settings
 */

@include 'local.settings.php';

//Hide AC reverse proxi
if (array_key_exists('HTTP_X_FORWARDED_FOR', $_SERVER)) {
$xff_path = explode(",", $_SERVER['HTTP_X_FORWARDED_FOR']);
$_SERVER['REMOTE_ADDR'] = trim($xff_path[0]);
}
