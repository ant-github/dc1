...
foreach($select_table_sizes AS $res_tables_sizes){
    if($res_tables_sizes->Tables == 'cache_form'){
        if($res_tables_sizes->size_in_MB > 1900){
...
<!--  <div class="hero-banner row">
    ...
    <div class="video col-sm-6">
      <div class="youtubeVideo" data-videoid="DMpmkiAmc8Q"></div>
      <a class="video-overlay" href="https://www.youtube.com/watch?v=DMpmkiAmc8Q"><img src="/sites/all/themes/hiddendelivery/images/HomePage/video-overlay.jpg" alt="" /></a>
    </div>
    <?php
